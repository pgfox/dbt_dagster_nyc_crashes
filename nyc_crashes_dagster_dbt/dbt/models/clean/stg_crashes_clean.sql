with remediated as (
    select
        ...
        longitude,
        location,
        case when on_street_name ~ '^\d+$' then null else on_street_name end       as on_street_name,
        case when cross_street_name ~ '^\d+$' then null else cross_street_name end as cross_street_name,
        case when off_street_name ~ '^\d+$' then null else off_street_name end     as off_street_name,
